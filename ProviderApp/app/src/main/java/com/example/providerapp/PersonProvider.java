...
public class PersonProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (uriMatcher.match(uri)){
            case PERSONS:
                cursor=database.query(ProviderHelper.TABLE_NAME,
                        ProviderHelper.ALL_CULUMNS,selection,
                        null,null,null,
                        ProviderHelper.PERSON_NAME+" ASC");
                break;
            default:
                throw new IllegalArgumentException("알수 없는 URI"+uri);
        }
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        switch (uriMatcher.match(uri)){
            case PERSONS:
                count=database.update(ProviderHelper.TABLE_NAME,
